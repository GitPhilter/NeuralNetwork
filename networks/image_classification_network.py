...
def get_ImageGreyscaleBinaryClassifyNetwork(name, image_width, image_height, random_weights=True):
    ...
    return ImageGreyscaleBinaryClassifyNetwork(name, [input_layer, hidden_layer, output_layer])
